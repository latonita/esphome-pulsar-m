...
class PulsarMUart final : public uart::ESP32ArduinoUARTComponent {
 public:
  PulsarMUart(uart::ESP32ArduinoUARTComponent const &uart) : uart_(uart), hw_(uart.*(&PulsarMUart::hw_serial_)) {}
...
class PulsarMUart final : public uart::ESP8266UartComponent {
 public:
  PulsarMUart(uart::ESP8266UartComponent const &uart)
      : uart_(uart), hw_(uart.*(&PulsarMUart::hw_serial_)), sw_(uart.*(&PulsarMUart::sw_serial_)) {}
